...
▀                                                                                 
        ...
        def Main():
            if platform.system() == "Windows":
                os.system("cls")
                pystyle.Write.Print(pystyle.Center.XCenter('''DOXTOOL\n'''), pystyle.Colors.cyan_to_green, interval = 0.0005)
            else:
                os.system("clear")
                pystyle.Write.Print(pystyle.Center.XCenter('''█DOXAMSTER\n'''), pystyle.Colors.cyan_to_green, interval = 0.0005)
...
█ [4] Поиск по IP       █                    
█ [5] Поиск по БД       █ [15] DDOS 2.0                       █
█ [6] DDoS              █ [16] Генератор вымышленной карты    █
█ [7] Генератор прокси  █ [17] Поиск по Mac-Address           █
█ [8] Св@т б@нв0рд      [18] Мануал по сносу аккаунта тг    
█ [9] Генератор паролей  [19] Генератор User-agent           
█ [10] Мануал по доксу   [20] Информация                     
█ [11] Мануал по свату                  █
█                       █                                     █
███████████████████████████████████████████████████████████████
█                                                             █
